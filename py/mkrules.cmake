...
add_custom_command(
    ...
    COMMAND ${CAT_CMD} ${MICROPY_QSTRDEFS_PY} ${MICROPY_QSTRDEFS_PORT} ${MICROPY_QSTRDEFS_COLLECTED} | ${MICROPY_PROCESS_QSTRDEFS_BAT1} > ${MICROPY_QSTRDEFS_PREPROCESSED_STEP1}
...
add_custom_command(
    ...
    COMMAND ${CMAKE_C_COMPILER} -E ${MICROPY_CPP_FLAGS} ${MICROPY_QSTRDEFS_PREPROCESSED_STEP1} | ${MICROPY_PROCESS_QSTRDEFS_BAT2} > ${MICROPY_QSTRDEFS_PREPROCESSED}
