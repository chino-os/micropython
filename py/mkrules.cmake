...
set(MICROPY_GENHDR_DIR "${CMAKE_CURRENT_BINARY_DIR}/genhdr")
...
set(MICROPY_QSTRDEFS_PREPROCESSED_STEP1 "${MICROPY_GENHDR_DIR}/qstrdefs.preprocessed.h.step1")
set(MICROPY_QSTRDEFS_PREPROCESSED_STEP2 "${MICROPY_GENHDR_DIR}/qstrdefs.preprocessed.h.step2")
...
set(MICROPY_PROCESS_QSTRDEFS_BAT1 "${MICROPY_PY_DIR}/qstrdefs1.bat")
set(MICROPY_PROCESS_QSTRDEFS_BAT2 "${MICROPY_PY_DIR}/qstrdefs2.bat")
cmake_path(NATIVE_PATH MICROPY_QSTRDEFS_PY NORMALIZE MICROPY_QSTRDEFS_PY)
cmake_path(NATIVE_PATH MICROPY_QSTRDEFS_COLLECTED NORMALIZE MICROPY_QSTRDEFS_COLLECTED)
cmake_path(NATIVE_PATH MICROPY_QSTRDEFS_PREPROCESSED NORMALIZE MICROPY_QSTRDEFS_PREPROCESSED)
cmake_path(NATIVE_PATH MICROPY_QSTRDEFS_PREPROCESSED_STEP1 NORMALIZE MICROPY_QSTRDEFS_PREPROCESSED_STEP1)
cmake_path(NATIVE_PATH MICROPY_QSTRDEFS_PREPROCESSED_STEP2 NORMALIZE MICROPY_QSTRDEFS_PREPROCESSED_STEP2)
cmake_path(NATIVE_PATH MICROPY_PROCESS_QSTRDEFS_BAT1 NORMALIZE MICROPY_PROCESS_QSTRDEFS_BAT1)
cmake_path(NATIVE_PATH MICROPY_PROCESS_QSTRDEFS_BAT2 NORMALIZE MICROPY_PROCESS_QSTRDEFS_BAT2)
...
if (WIN32)
    get_filename_component(GIT_BASH_ROOT ${GIT_EXECUTABLE} DIRECTORY CACHE)
    if ($ENV{CI})
        set(SED_CMD ${GIT_BASH_ROOT}/../../usr/bin/sed)
    else()
        set(SED_CMD ${GIT_BASH_ROOT}/../usr/bin/sed)
    endif()
    cmake_path(NATIVE_PATH SED_CMD NORMALIZE SED_CMD)   
else()
    set(SED_CMD sed)
endif()
...
add_custom_command(
    ...
    COMMAND ${TOUCH_CMD} ${MICROPY_QSTRDEFS_SPLIT}
...
add_custom_command(
    OUTPUT ${MICROPY_QSTRDEFS_PREPROCESSED_STEP1}
    COMMAND ${CAT_CMD} ${MICROPY_QSTRDEFS_PY} ${MICROPY_QSTRDEFS_PORT} ${MICROPY_QSTRDEFS_COLLECTED} | ${MICROPY_PROCESS_QSTRDEFS_BAT1} ${SED_CMD} > ${MICROPY_QSTRDEFS_PREPROCESSED_STEP1}
...
add_custom_command(
    ...
    COMMAND ${CMAKE_C_COMPILER} -E ${MICROPY_CPP_FLAGS} ${MICROPY_QSTRDEFS_PREPROCESSED_STEP1} | ${MICROPY_PROCESS_QSTRDEFS_BAT2} ${SED_CMD} > ${MICROPY_QSTRDEFS_PREPROCESSED}
    DEPENDS ${MICROPY_QSTRDEFS_PREPROCESSED_STEP1}
    VERBATIM
    COMMAND_EXPAND_LISTS
)
...
#add_custom_command(
#    OUTPUT ${MICROPY_QSTRDEFS_PREPROCESSED}
#    COMMAND ${CAT_CMD} ${MICROPY_QSTRDEFS_PY} ${MICROPY_QSTRDEFS_PORT} ${MICROPY_QSTRDEFS_COLLECTED} | ${MICROPY_PROCESS_QSTRDEFS_BAT1} | ${CMAKE_C_COMPILER} -E ${MICROPY_CPP_FLAGS} - | ${MICROPY_PROCESS_QSTRDEFS_BAT2} > ${MICROPY_QSTRDEFS_PREPROCESSED}
#    DEPENDS ${MICROPY_QSTRDEFS_PY}
#        ${MICROPY_QSTRDEFS_PORT}
#        ${MICROPY_QSTRDEFS_COLLECTED}
#    VERBATIM
...
add_custom_command(
    ...
    COMMAND ${TOUCH_CMD} ${MICROPY_MODULEDEFS_SPLIT}
    DEPENDS ${MICROPY_QSTRDEFS_LAST}
    VERBATIM
    COMMAND_EXPAND_LISTS
)
...
add_custom_command(
    ...
    COMMAND ${TOUCH_CMD} ${MICROPY_ROOT_POINTERS_SPLIT}
    DEPENDS ${MICROPY_QSTRDEFS_LAST}
    VERBATIM
    COMMAND_EXPAND_LISTS
)
